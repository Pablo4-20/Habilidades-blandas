...
const GestionHabilidades = () => {
    ...
    // Estado para gestionar las actividades en el formulario
    ...
    // MANEJADORES DE ACTIVIDADES DINÁMICAS
    ...
    const agregarCampoActividad = () => {
        setActividadesForm([...actividadesForm, '']);
    };
    ...
    const handleGuardar = async (e) => {
        ...
        // Filtrar actividades vacías antes de enviar
    ...
    const downloadTemplate = () => {
        const data = [
            { 
                Nombre: "Liderazgo", 
                Descripcion: "Capacidad de guiar...", 
                "Actividad 1": "Rubricas de evaluación",
                "Actividad 2": "Autoevaluación"
            },
            { 
                Nombre: "Pensamiento Crítico", 
                Descripcion: "Análisis objetivo...", 
                "Actividad 1": "Debates",
                "Actividad 2": "" 
            }
        ];
    ...
    return (
        <div className="space-y-6 animate-fade-in pb-20">
            ...
            {/* TABLA DE HABILIDADES - REDISEÑADA CON COLUMNA DE ACTIVIDADES */}
                        ...
                        {loading ? (
                            ...
                            filteredData.map((item) => (
                                <tr key={item.id} className="hover:bg-gray-50 transition">
                                    ...
                                    {/* COLUMNA 3: ACTIVIDADES (NUEVA COLUMNA) */}
                                    <td className="px-6 py-4 align-top">
            ...
            {/* MODAL IMPORTAR (CON TABLA DE EJEMPLO) */}
            {showImportModal && (
